...
import { DiAndroid, DiJava, DiJavascript } from 'react-icons/di'
        ...
        <div className='border-b border-neutral-800 pb-24'>
            ...
            <motion.div whileInView={{opacity:1, x:0}} initial={{opacity:0, x:-100}} transition={{duration:1.5}} className="flex flex-wrap items-center justify-center gap-4">
                ...
                <motion.div variants={iconVariants(2)} initial="initail" animate="animate" className="rounded-2xl border-4 border-neutral-800 p-4">
                    <DiAndroid className='text-7xl text-green-600 ' />
                </motion.div>
                ...
                <motion.div variants={iconVariants(3.6)} initial="initail" animate="animate" className="rounded-2xl border-4 border-neutral-800 p-4">
                    <FaNodeJs className='text-7xl text-green-500 ' />
                </motion.div>
                <motion.div variants={iconVariants(6)} initial="initail" animate="animate" className="rounded-2xl border-4 border-neutral-800 p-4">
                    <DiJava className='text-7xl text-orange-700 ' />
                </motion.div>
                <motion.div variants={iconVariants(2.4)} initial="initail" animate="animate" className="rounded-2xl border-4 border-neutral-800 p-4">
                    <SiExpress className='text-7xl' />
                </motion.div>
                <motion.div variants={iconVariants(4.4)} initial="initail" animate="animate" className="rounded-2xl border-4 border-neutral-800 p-4">
