...
import profilePic from '../assets/swProfile.jpg'
            ...
            <div className='flex flex-wrap'>
                <div className='w-full lg:w-1/2'>
                    <div className='flex flex-col items-center lg:items-start'>
                        <motion.h1 variants={container(0)} initial="hidden" animate='visible' className='pb-16 text-5xl font-thin tracking-tight lg:mt-16 lg:text-8xl'>Shreyas Wagire</motion.h1>
